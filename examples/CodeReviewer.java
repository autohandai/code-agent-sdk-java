 ...
 *
 * Run with:
 *   AUTOHAND_CLI_PATH=/path/to/autohand mvn compile exec:java -Dexec.mainClass="CodeReviewer"
 */
public class CodeReviewer {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            String prompt = "What Java files are in the current directory? Read each one and report any issues.";
