...
public record AutohandEnvVars(
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL) String AUTOHAND_AI_API_KEY,
    @JsonInclude(JsonInclude.Include.NON_NULL) String AUTOHAND_AI_BASE_URL,
    @JsonInclude(JsonInclude.Include.NON_NULL) String AUTOHAND_AI_PLAN,
    @JsonInclude(JsonInclude.Include.NON_NULL) String AUTOHAND_DEBUG,
    @JsonInclude(JsonInclude.Include.NON_NULL) String AUTOHAND_CODE_SIMPLE,
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL) String AUTOHAND_NO_IDLE_LOGOUT,
