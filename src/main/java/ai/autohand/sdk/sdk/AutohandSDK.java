...
public final class AutohandSDK implements AutoCloseable {
    ...
    public DirectoryAccessAcknowledgement.Result acknowledgeDirectoryAccess(String requestId) {
        ensureStarted();
        return RPCClient.convert(
                client.request("autohand.directoryAccessAcknowledged",
                        new DirectoryAccessAcknowledgement.Params(requestId)),
    ...
    public McpInvocationResponse.Result respondMcpInvocation(McpInvocationResponse.Params params) {
        ensureStarted();
    ...
    public LearnUpdate.Result updateLearn() {
        ensureStarted();
        return client.request("autohand.learn.update", Map.of(), LearnUpdate.Result.class);
    }

    public LearnGeneration.Result generateLearn(LearnGeneration.Scope scope) {
        ensureStarted();
        return client.request("autohand.learn.generate",
